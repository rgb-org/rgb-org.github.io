...
As a smart contract system RGB is quite different from previous approaches, both Bitcoin-based \(Colored coins, Counterparty, OMNI, [Dogecoin stock](https://coindataflow.com/en/currency/dogecoin)\) and non-bitcoin \(Ethereum, EOS and others\):
